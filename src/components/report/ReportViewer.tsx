    ...
    <div className="w-full space-y-4">
      ...
      <div className="border rounded-lg overflow-hidden">
        <button
          ...
          className="w-full flex items-center justify-between p-4 bg-muted hover:bg-muted/70 dark:hover:bg-muted/50 transition-colors"
        >
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y">
                {previewData.map((row, rowIndex) => (
                  <tr key={rowIndex} className="hover:bg-muted/50 dark:hover:bg-muted/20">
